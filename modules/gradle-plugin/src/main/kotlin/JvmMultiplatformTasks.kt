...
private fun Project.createJvmStorytaleGenerateSourceTask(extension: StorytaleExtension, target: KotlinJvmTarget) {
...
fun Project.createJvmStorytaleCompileTask(extension: StorytaleExtension, target: KotlinJvmTarget): KotlinJvmCompilation {
